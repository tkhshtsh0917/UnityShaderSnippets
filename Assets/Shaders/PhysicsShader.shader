Shader "Custom/PhysicsShader"
{
    ...
    SubShader
    {
        ...
        float CalculateFresnelDiffuse(float3 normal, float3 lightDir, float3 viewDir)
        {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Fresnel Diffuse
                float fresnelDiffuse = CalculateFresnelDiffuse(i.normal, i.lightDir, i.viewDir);

                // Normalized Lambert Diffuse
                float lambertDiffuse = saturate(dot(i.normal, i.lightDir));

                float diffuse = fresnelDiffuse * lambertDiffuse / PI;
